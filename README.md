...
```bash
curl -L https://github.com/aiocean/clik-releases/releases/download/v0.9.0/clik_0.9.0_aarch64.dmg -o ~/Downloads/Clik.dmg && open ~/Downloads/Clik.dmg
```

**Intel:**
```bash
curl -L https://github.com/aiocean/clik-releases/releases/download/v0.9.0/clik_0.9.0_x86_64.dmg -o ~/Downloads/Clik.dmg && open ~/Downloads/Clik.dmg
```
