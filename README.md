...
```bash
curl -L https://github.com/aiocean/clik-releases/releases/download/v0.6.1/clik_0.6.1_aarch64.dmg -o ~/Downloads/Clik.dmg && open ~/Downloads/Clik.dmg
```

**Intel:**
```bash
curl -L https://github.com/aiocean/clik-releases/releases/download/v0.6.1/clik_0.6.1_x86_64.dmg -o ~/Downloads/Clik.dmg && open ~/Downloads/Clik.dmg
```
